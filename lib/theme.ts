...
export const tw = {
  ...
  btnPrimarySm:
    "inline-flex items-center justify-center gap-1 rounded-full px-3.5 py-1.5 font-label text-[10px] font-semibold text-white whitespace-nowrap transition-all duration-300 bg-gradient-to-br from-primary-mid to-accent max-w-full",
  btnDark:
    "inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 font-label text-sm font-semibold text-white bg-primary transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary-mid",
  btnOutline:
